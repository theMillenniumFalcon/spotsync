...
const Editor = ({ user, playlist, expiry, owner }: InferGetServerSidePropsType<GetServerSideProps>) => {
          ...
          {session ? (
            <>
              ...
              <div className="dashboard-scroll flex h-full overflow-x-auto">
                ...
                <EditorComponent setEditorScroll={setEditorScroll} setOpen={setSongDialogOpen} />
              </div>
            </>
          ) : (
            <NoAuth />
